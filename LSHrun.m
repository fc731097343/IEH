trainset = fvecs_read ('../gist/gist_base.fvecs');
testset = fvecs_read ('../gist/gist_query.fvecs');
gnd = ivecs_read ('../gist/gist_groundtruth.ivecs');
trainset = trainset';
testset = testset';
gnd = gnd';
%disp(trainset(1:3,:));
...
disp(errornum);
%}
fid = fopen('LSHtableGIST16b.txt','wt');
...
fid = fopen('LSHfuncGIST16b.txt','wt');
